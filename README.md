...
| Лист | Содержание |
|------|-----------|
| **Журнал изменений** | История аудитов |
...
| **Ref Units** | Ref-токены единиц измерения |
| **Sys Units** | Sys-токены единиц измерения |
| **Component Units** | Компонентные токены единиц измерения |
| **Action items** | ⚠️ Не перезаписывается — ручные заметки |
| **FAQ** | ⚠️ Не перезаписывается — вопросы и ответы |
